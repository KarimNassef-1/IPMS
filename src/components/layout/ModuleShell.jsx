export default function ModuleShell({
  ...
  return (
    <section className={`rounded-2xl border border-white/30 bg-white/65 p-4 shadow-[0_18px_46px_-24px_rgba(15,23,42,0.35)] backdrop-blur-xl sm:rounded-3xl sm:p-5 lg:p-6 ${variantClass}`}>
      <div className="mb-5 flex flex-wrap items-start justify-between gap-3 border-b border-slate-200/70 pb-4 sm:mb-6 sm:pb-5">
        <div className="max-w-3xl">
          ...
          <h3 className="ip-shell-title mt-1 text-xl font-black tracking-tight text-slate-900 sm:text-2xl">{title}</h3>
